        ...
        case "file":
            return (
                <a
                    ...
                    className="mt-2 flex items-center gap-3 bg-[#f0f4f8] hover:bg-[#e4eaf0] transition-colors rounded-lg p-3 group"
                >
                    <div className="w-10 h-10 rounded-lg bg-[#3390ec] flex items-center justify-center shrink-0">
                        <svg
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-[#3390ec] group-hover:underline truncate">
                            {message.originalFileName}
                        </p>
